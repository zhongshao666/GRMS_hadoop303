...
//读取两个文件
public class MultiplyGoodsMatrixAndUserVector2
...
//                    String k = i + "," + j;
    ...
    public int run(String[] args) throws Exception {
        ...
        String output = "src/main/java/com/briup/GRMS/Step5_1/result";
...
//        job.setPartitionerClass(KeyPartitionor.class);
    ...
    public static void main(String[] args) throws Exception {
        ToolRunner.run(
                new MultiplyGoodsMatrixAndUserVector2(), args);
    }
}
